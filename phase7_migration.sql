...
-- Creates all tables for governance, analytics, risk, and audit functionality
...
CREATE TABLE IF NOT EXISTS `executedChanges` (
	`id` int AUTO_INCREMENT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `marketPredictions` (
	`id` int AUTO_INCREMENT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `strategyRecommendations` (
	`id` int AUTO_INCREMENT NOT NULL,
